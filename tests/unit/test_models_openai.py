...
class TestTool:
    ...
    def test_function_is_optional_for_flat_format(self):
        ...
        """
        print(
            "Setup: Creating Tool with flat format (name, description, input_schema)..."
        )
        tool = Tool(
            type="function",
            name="test_tool",
        ...
        print(
            f"Comparing description: Expected 'A test tool', Got '{tool.description}'"
        )
    ...
    def test_standard_format_still_works(self):
        ...
        print(f"Result: {tool}")
        print(
            f"Comparing function.name: Expected 'standard_tool', Got '{tool.function.name}'"
        )
...
class TestReasoningEffort:
    ...
    def test_reasoning_effort_invalid_value_rejected(self):
        ...
        """
        print(
            "Attempting to create ChatCompletionRequest with invalid reasoning_effort..."
        )

...
class TestNormalizeModelName:
    ...
    def test_inverted_format_requires_suffix(self):
        ...
        print(
            f"Comparing result: Expected 'claude-3.7-sonnet' (unchanged), Got '{result}'"
        )
        assert result == "claude-3.7-sonnet"
        ...
        print(
            f"Comparing result: Expected 'claude-4.5-sonnet' (unchanged), Got '{result2}'"
        )
...
class TestGetModelIdForKiro:
    ...
    def test_returns_internal_id_for_hidden_model(self):
        ...
        print(
            f"Comparing result: Expected 'CLAUDE_3_7_SONNET_20250219_V1_0' (pass-through), Got '{result}'"
        )
    ...
    def test_passthrough_unknown_model(self):
        ...
        print(
            f"Comparing result: Expected 'claude-unknown-model' (pass-through), Got '{result}'"
        )
...
class TestModelAliasSystemBasics:
    ...
    def test_alias_resolves_to_target_model(self, mock_model_cache):
        ...
        print(
            f"Comparing original_request: Expected 'auto-kiro', Got '{result.original_request}'"
        )
...
class TestModelAliasSystemEdgeCases:
    ...
    def test_alias_to_non_existent_model(self, mock_model_cache):
        ...
        print(
            f"Comparing internal_id: Expected 'claude-haiku-5.0' (pass-through), Got '{result.internal_id}'"
        )
    ...
    def test_alias_to_hidden_model(self, mock_model_cache):
        ...
        resolver = ModelResolver(
            cache=mock_model_cache, hidden_models=hidden, aliases=aliases
        )
    ...
    def test_alias_with_same_name_as_real_model(self, mock_model_cache):
        ...
        print(
            f"Comparing internal_id: Expected 'claude-sonnet-4.5', Got '{result.internal_id}'"
        )
    ...
    def test_alias_case_sensitivity(self, mock_model_cache):
        ...
        print(
            f"Comparing internal_id: Expected 'AUTO-KIRO' (pass-through, no alias match), Got '{result.internal_id}'"
        )
...
class TestHiddenFromListFunctionality:
    ...
    def test_hidden_model_not_in_available_list(self, mock_model_cache):
        ...
        resolver = ModelResolver(
            cache=mock_model_cache, hidden_from_list=hidden_from_list
        )
    ...
    def test_alias_appears_when_original_hidden(self, mock_model_cache):
        ...
        hidden_from_list = ["auto"]
        resolver = ModelResolver(
            cache=mock_model_cache, aliases=aliases, hidden_from_list=hidden_from_list
        )

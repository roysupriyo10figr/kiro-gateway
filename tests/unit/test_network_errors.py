...
class TestClassifyNetworkErrorDNS:
    ...
    def test_dns_error_with_socket_gaierror_windows(self):
        ...
        """
        print(
            "Setup: Creating ConnectError with socket.gaierror (Windows errno 11001)..."
        )
        ...
        print(
            f"Comparing category: Expected {ErrorCategory.DNS_RESOLUTION}, Got {error_info.category}"
        )
    ...
    def test_dns_error_includes_troubleshooting_steps(self):
        ...
        assert any(
            "firewall" in step.lower() or "antivirus" in step.lower() for step in steps
        )
...
class TestClassifyNetworkErrorConnection:
    ...
    def test_connection_refused_error(self):
        ...
        print(
            f"Comparing category: Expected {ErrorCategory.CONNECTION_REFUSED}, Got {error_info.category}"
        )
    ...
    def test_connection_reset_error(self):
        ...
        print(
            f"Comparing category: Expected {ErrorCategory.CONNECTION_RESET}, Got {error_info.category}"
        )
    ...
    def test_network_unreachable_error(self):
        ...
        print(
            f"Comparing category: Expected {ErrorCategory.NETWORK_UNREACHABLE}, Got {error_info.category}"
        )
    ...
    def test_generic_connect_error_classified_as_unknown(self):
        ...
        print(
            f"Comparing category: Expected {ErrorCategory.UNKNOWN}, Got {error_info.category}"
        )
...
class TestClassifyNetworkErrorTimeout:
    ...
    def test_connect_timeout_error(self):
        ...
        print(
            f"Comparing category: Expected {ErrorCategory.TIMEOUT_CONNECT}, Got {error_info.category}"
        )
    ...
    def test_connect_timeout_includes_troubleshooting(self):
        ...
        assert any(
            "server" in step.lower() or "overloaded" in step.lower() for step in steps
        )
    ...
    def test_read_timeout_error(self):
        ...
        print(
            f"Comparing category: Expected {ErrorCategory.TIMEOUT_READ}, Got {error_info.category}"
        )
    ...
    def test_read_timeout_includes_troubleshooting(self):
        ...
        assert len(steps) >= 2
        assert any(
            "server" in step.lower() or "processing" in step.lower() for step in steps
        )
...
class TestClassifyNetworkErrorSSL:
    ...
    def test_ssl_error_detection(self):
        ...
        print(
            f"Comparing category: Expected {ErrorCategory.SSL_ERROR}, Got {error_info.category}"
        )
...
class TestClassifyNetworkErrorProxy:
    ...
    def test_proxy_error_detection(self):
        ...
        print(
            f"Comparing category: Expected {ErrorCategory.PROXY_ERROR}, Got {error_info.category}"
        )
...
class TestClassifyNetworkErrorRedirects:
    ...
    def test_too_many_redirects_error(self):
        ...
        print(
            f"Comparing category: Expected {ErrorCategory.TOO_MANY_REDIRECTS}, Got {error_info.category}"
        )
...
class TestFormatErrorForUser:
    ...
    def test_format_openai_includes_troubleshooting(self):
        ...
        formatted = format_error_for_user(
            error_info, format_type="openai", include_troubleshooting=True
        )
    ...
    def test_format_openai_without_troubleshooting(self):
        ...
        formatted = format_error_for_user(
            error_info, format_type="openai", include_troubleshooting=False
        )
    ...
    def test_format_generic_includes_technical_details(self):
        ...
        assert (
            formatted["error"]["technical_details"]
            == "ConnectError: SSL handshake failed"
        )
...
class TestGetShortErrorMessage:
    ...
    def test_short_message_different_categories(self):
        ...
        errors = [
            NetworkErrorInfo(
                ErrorCategory.TIMEOUT_CONNECT, "Timeout", [], "Tech", True, 504
            ),
            NetworkErrorInfo(
                ErrorCategory.CONNECTION_REFUSED, "Refused", [], "Tech", True, 502
            ),

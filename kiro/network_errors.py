...
def _classify_connect_error(
    error: httpx.ConnectError, technical_details: str
) -> NetworkErrorInfo:
    """
...
def _classify_timeout_error(
    error: httpx.TimeoutException, technical_details: str
) -> NetworkErrorInfo:
    """
...
def format_error_for_user(
    ...
    # Format for Anthropic API
        ...
        return {
            "type": "error",
            "error": {"type": "connectivity_error", "message": message.strip()},
        }
